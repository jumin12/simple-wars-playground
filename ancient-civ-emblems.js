...
(function (global) {
    const WOD_ANCIENT_CIV_SVG = {
        ...
        civCarthage: {
            ...
            size: 512,
            paths: [
                'M226.8 132.8 A43.8 43.8 0 1 1 285.2 132.8 A32.5 32.5 0 1 0 226.8 132.8',
                'M256 215.4 m-63.6 0 a63.6 63.6 0 1 0 127.2 0 a63.6 63.6 0 1 0 -127.2 0',
                'M234.8 279 L164.1 455.7 L347.9 455.7 L277.2 279 Z',
                'M121.7 277.6 L121.7 283.2 L390.3 283.2 L390.3 277.6'
            ]
        },
        civGaul: {
            ox: 256,
